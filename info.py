...
BOT_TOKEN = environ.get('BOT_TOKEN', '6563756411:AAFExD0jNl2vHFh62iG6LVx-X8jk7u-Hq-0')
...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1001847880984').split()]
...
# Others
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1001987015809' ))
...
FILE_STORE_CHANNEL = [int(ch) for ch in (environ.get('FILE_STORE_CHANNEL', '-1001854391561')).split()]
...
lazy_renamers = [int(lazrenamers) if id_pattern.search(lazrenamers) else lazrenamers for lazrenamers in environ.get('LAZY_RENAMERS', '-1001854391561').split()]
LAZY_RENAMERS = (lazy_renamers + ADMINS) if lazy_renamers else []
REQ_CHANNEL = int(environ.get('REQ_CHANNEL', '-1001987015809'))
#ai
OPENAI_API = environ.get("OPENAI_API","")
AI = is_enabled((environ.get("AI","False")), False)
LAZY_AI_LOGS = int(environ.get("LAZY_AI_LOGS","-1001987015809")) #GIVE YOUR NEW LOG CHANNEL ID TO STORE MESSAGES THAT THEY SEARCH IN BOT PM.... [ i have added this to keep an eye on the users message, to avoid misuse of LazyPrincess ]
