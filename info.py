...
API_ID = int(environ['API_ID' '8236749'])
API_HASH = environ['API_HASH' 'abd9b977fd5979b84c8b04318a80e251']
BOT_TOKEN = environ['BOT_TOKEN' '6563756411:AAFExD0jNl2vHFh62iG6LVx-X8jk7u-Hq-0']
...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1001942057531').split()]
